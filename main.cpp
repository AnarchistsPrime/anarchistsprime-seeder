...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "AnarchistsPrime-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.acp.ssdpool.com",""};
...
extern "C" void* ThreadSeeder(void *arg) {
  ...
  if (!fTestNet){
    db.Add(CService(opts->ns, 11050, true), true);
  }
  do {
...
int main(int argc, char **argv) {
  ...
  if (opts.tor) {
    CService service(opts.tor, 11050);
    if (service.IsValid()) {
